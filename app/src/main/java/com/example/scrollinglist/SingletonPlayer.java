...
public class SingletonPlayer {
    private static final com.example.scrollinglist.SingletonPlayer instance = new com.example.scrollinglist.SingletonPlayer();
    public static com.example.scrollinglist.SingletonPlayer getInstance() { return instance; }
